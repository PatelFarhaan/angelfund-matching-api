...
from project.models import Startup, Investor, Referrals, InviteCodes
...
#                                        VERIFY INVITE CODE
# <==================================================================================================>
@startup_blueprint.route('/verify-invite-code', methods=['POST'])
@jwt_required
